...
function Home() {
  return (
    <div className='bg-zinc-800 '>
       <div className='flex justify-center items-center  flex-col lg:min-h-[80vh] min-h-[100vh]'>
       <img src={img} alt="" className='md:h-[400px] md:w-[600px] h-[200px] w-[200px]  sm:h-[350px] sm:w-[400px] ' />
